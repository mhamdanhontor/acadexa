...
function buildMenu() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'About Honor Knowledge Academy',
          click: () => {
            dialog.showMessageBox(mainWindow, {
              type: 'info',
              title: 'About Honor Knowledge Academy',
              message: `Honor Knowledge Academy Desktop\nVersion ${app.getVersion()}`,
              detail:
                'Academy Attendance & Student Management System.\n' +
                'This desktop app connects to your central academy server.',
            })
          },
        },
      ],
